                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" maxlength="100" value="<?=$context['lesson']['title']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Lesson Content</label>
                                <textarea class="summernote" rows="5" name="content" maxlength="30000"><?=$context['lesson']['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group fallback text-primary">
                                Note that uploading new files overwrites previous files
                            </div>
                        </div>
