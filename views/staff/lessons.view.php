                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td><?=$lesson['title']; ?></td>
                                    <td>
                                        <a href="view-lesson?lesson_id=<?=$lesson['id']; ?>" class="btn btn-sm btn-primary"><i class="la la-eye"></i></a>
                                        <a href="edit-lesson?lesson_id=<?=$lesson['id']; ?>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                        <a href="delete-lesson?lesson_id=<?=$lesson['id']; ?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                            <?php endif ?>
