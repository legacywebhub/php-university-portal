                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Welcome back! Sign in as a staff</h4>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <label><strong>Staff ID <span class="text-danger">*</span></strong></label>
                                            <input type="text" name="staff_id" class="form-control" maxlength="10" onkeypress="return onlyNumberKey(event)" required>
                                        </div>
                                        <div class="form-group">
