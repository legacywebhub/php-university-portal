<div class="row">
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header">
                ...
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_students']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header">
                <h3 class="card-title text-white">Total Staffs</h3>
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_staffs']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header pb-3">
                <h3 class="card-title text-white">Super staffs</h3>
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_superstaffs']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header pb-3">
                <h3 class="card-title text-white">Total Faculties</h3>
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_faculties']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header pb-3">
                <h3 class="card-title text-white">Total Departments</h3>
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_departments']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header pb-3">
                ...
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_courses']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-primary overflow-hidden">
            <div class="card-header pb-3">
                <h3 class="card-title text-white">Total Lessons</h3>
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_lessons']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
    ...
    <div class="col-xl-4 col-xxl-4 col-sm-6">
        <div class="widget-stat card bg-dark overflow-hidden">
            <div class="card-header pb-3">
                ...
                <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> <?=$context['superstaff']['total_messages']; ?></h5>
            </div>
            <div class="card-body text-center text-light mt-1">
                    ...
                    <ul class="timeline">
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic1.jpg">
                                <div class="col">
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic2.jpg">
                                <div class="col">
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic3.jpg">
                                <div class="col">
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic4.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            <div class="timeline-badge warning"></div>
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic5.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Resport created successfully</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic6.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Reminder : Treatment Time!</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic7.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            <div class="timeline-badge danger"></div>
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic8.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Resport created successfully</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            <div class="timeline-badge success"></div>
                            <a class="timeline-panel text-muted mb-3 d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic9.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Reminder : Treatment Time!</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                        ...
                        <li>
                            ...
                            <a class="timeline-panel text-muted d-flex align-items-center" href="javascript:void(0);">
                                <img class="rounded-circle" alt="image" width="50" src="<?=STATIC_ROOT; ?>/dashboard/images/profile/education/pic10.jpg">
                                <div class="col">
                                    <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                    <small class="d-block">29 July 2020 - 02:26 PM</small>
                                </div>
                                    ...
                                    <a href="javascript:void(0);">
                                        <div class="media d-flex align-items-center">
                                            <div class="avatar avatar-xl mr-2">
                                                <img class="rounded-circle img-fluid" src="<?=STATIC_ROOT; ?>/dashboard/images/avatar/5.png" width="30" alt="">
                                            </div>
                            ...
                            <tr class="btn-reveal-trigger">
                                <td class="p-3">
                                    <a href="javascript:void(0);">
                                        <div class="media d-flex align-items-center">
                                            <div class="avatar avatar-xl mr-2">
                                                <img class="rounded-circle img-fluid" src="<?=STATIC_ROOT; ?>/dashboard/images/avatar/1.png" alt="" width="30">
                                            </div>
                                            <div class="media-body">
