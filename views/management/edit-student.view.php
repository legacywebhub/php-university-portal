                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <?php if($context['student']['passport']): ?>
                                <img class="image-preview" src="<?=MEDIA_ROOT; ?>/users/<?=$context['student']['passport']; ?>">
                            <?php else: ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="level" required>
                                    <option value=<?=$context['student']['level']; ?>><?=$context['student']['level']; ?></option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="fname" class="form-control" maxlength="30" value="<?=$context['student']['firstname']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Middle Name</label>
                                <input type="text" name="mname" maxlength="30" value="<?=$context['student']['middlename']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Last Name <span class="text-danger">*</span></label>
                                <input type="text" name="lname" class="form-control" maxlength="30" value="<?=$context['student']['lastname']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="gender" required>
                                    <option value="<?=$context['student']['gender']; ?>"><?=$context['student']['gender']; ?></option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="dob" id="datepicker1" class="datepicker-default form-control" maxlength="10" value="<?=$context['student']['dob']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" name="email" class="form-control" maxlength="60" value="<?=$context['student']['email']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Mobile Number <span class="text-danger">*</span></label>
                                <input type="text" name="phone" class="form-control" maxlength="20" value="<?=$context['student']['phone']; ?>" required>
                            </div>
                        </div>
