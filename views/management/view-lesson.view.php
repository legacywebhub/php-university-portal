...
<div class="row">
    <div class="col-xl-12 col-xxl-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h4 class="text-primary">Course Content</h4>
                ...
                <?php if(!empty($context['videos'])): ?>
                    <?php foreach($context['videos'] as $video): ?>
                        <div class="my-2">
                            <video src="<?=MEDIA_ROOT; ?>/lessons/videos/<?=$video['video']; ?>" width="100%" controls></video>
                        </div>
                    <?php endforeach ?>
                <?php endif ?>
                ...
                <div class="text-center mt-2">
                    <a href="edit-lesson?lesson_id=<?=$context['lesson']['id']; ?>" class="btn btn-primary">Edit</a>
                </div>
            </div>
        </div>
    </div>
