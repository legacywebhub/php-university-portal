                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="faculty_id" required>
                                    <option value=<?=$context['department']['faculty_id']; ?>><?=fetch_faculty($context['department']['faculty_id']); ?></option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="department_code" maxlength="3" value=<?=$context['department']['department_code']; ?> onkeypress="return onlyNumberKey(event)" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Department Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" maxlength="160" value="<?=$context['department']['name']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Department Short Name <span class="text-danger">*</span></label>
                                <input type="text" name="short_name" maxlength="3" class="form-control" value="<?=$context['department']['short_name']; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="start_level" required>
                                    <option value=<?=$context['department']['start_level']; ?>><?=$context['department']['start_level']; ?></option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="end_level" required>
                                    <option value=<?=$context['department']['end_level']; ?>><?=$context['department']['end_level']; ?></option>
                                    <option value=100>100</option>
                                    <option value=200>200</option>
                                    <option value=300>300</option>
                                    <option value=400>400</option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="HOD" maxlength="100" value="<?=$context['department']['head_of_department']; ?>" class="form-control">
                            </div>
                        </div>
